...
$_lang["send"] = "Envoyer";
$_lang["contact.message.sent"] = "Merci de nous avoir contacté. Nous vous réponderons dès que possible.";
$_lang["topic"] = "Sujet";
$_lang["contact.message.too.short"] = "Votre message est trop court. Minimum 10 caractères.";
$_lang["contact.topic.too.short"] = "Votre sujet est trop court. Minimum 10 caractères.";
$_lang["invalid.mail.forgot.password"] = "Aucun compte ne correspond a l'e-mail indiqué.";
$_lang["error.cannot.fetch.steam.api"] = "Impossible de récupérer votre profile steam. Veuillez réessayer ultérieurement.";
