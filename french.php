...
$_lang["send"] = "Envoyer";
$_lang["contact.message.sent"] = "Message Envoyé! merci de nous avoir contacté. Nous vous réponderons dès que possible.";
$_lang["topic"] = "Sujet";
$_lang["contact.message.too.short"] = "Votre message est trop court. 10 caractères minimum.";
$_lang["contact.topic.too.short"] = "Votre sujet est trop court. 10 caractères minimum.";
$_lang["invalid.mail.forgot.password"] = "Aucun compte ne correspond au mail indiqué.";
